...
- On Nix, `nix develop` from the repo root provides Node.js 24, pnpm 11.7.0, uv, Python 3, Git, and — on Linux — the `bwrap` sandbox runner; `flake.lock` pins the nixpkgs commit it uses.
